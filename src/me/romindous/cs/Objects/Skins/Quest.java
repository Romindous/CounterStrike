...
public enum Quest {
	...
	CYBER(1, "§7Убей врага в §eдыму, §7в §eголову, §7при §eслепоте", GunType.AWP, "cyber", "Кибернетики"),
	...
	CRYSTAL(4, "§7Получи §e% §7(Убийства / Смерти) на §5Эстафете", GunType.SCAR, "crystal", "Аметистовая Песня"),
	SCULK(0, "§7Убей врага через стену на §5Классике", GunType.SG13, "sculk", "Хранитель Душ"),
    ICICLE(4000, "§7Накопи §e% §7кредитов за игру §5Контры", GunType.DGL, "icicle", "Кованный во Льдах"),
	HAPPINESS(20, "§7Сломай §e% §7спавнеров за игру §5Вторжения", GunType.MP5, "happiness", "Ключ к Счастью"),
    SHARD(100, "§7Поставить §e% §7бомб на §5Классике", GunType.TP9, "shard", "Звон Кристалов"),
	ACID(1, "§7Убей врага с §e% хп §7в игре §5Контры", GunType.NOVA, "acid", "Кислотный Дождь"),
	NETHERITE(32, "§7Убей §e% §7противников за игру §5Эстафеты", GunType.AK47, "netherite", "Посол Преисподней"),
