...
public record TeamMenu(Arena ar) implements InventoryProvider {
    ...
    public void init(final Player p, final InventoryContent its) {
        ...
        if (ar instanceof Invasion) {
            its.set(2, ClickableItem.of(new ItemBuilder(ItemType.SLIME_BALL).name("§cВыход")
                .lore(slrs).build(), e -> ar.rmvPl(sh)));
